      ...
      <header className={classes.header}>
        <Group justify="space-between" h="100%">
              ...
              <HoverCard position="bottom" radius="md" shadow="md" withinPortal>
                ...
                <HoverCard.Dropdown>
                  ...
                  <div className={classes.dropdownFooter}>
                    <Group justify='end'>
                      <Button variant='outline' onClick={logoff}>Sair</Button>
                    </Group>
                  </div>
                </HoverCard.Dropdown>
              </HoverCard>
          ...
          <Group visibleFrom="sm">
            {!isAuthenticated && (
              <Button component={Link} variant='link' to='/login'>Entrar</Button>
            )}
            {isAuthenticated && (
              <Stack>
                <Center>
        ...
        <ScrollArea h={`calc(100vh - ${rem(80)})`} mx="-md">
          ...
          {isAuthenticated && (
            <>
              ...
              <Collapse in={linksOpened} ml='md' mt='md'>{links}</Collapse>
            </>
          )}
          ...
          <Group justify="center" grow pb="xl" px="md">
            {isAuthenticated && (
              <Button variant='outline' fullWidth={true} onClick={logoff}>Sair</Button>
            )}
