...
export default function NewTracklog(props: {
  Tracklog: TrackLog;
  close: () => void;
  ...
  return (
    <Container>
      <Card padding="0" radius={0} className={classes.card}>
        <Group p="xs">
          <Avatar src={props.Tracklog.userData!.photoURL} size="sm" radius="xl" />
        ...
        <Card.Section m={0} p={0}>
          ...
          <Paper p="sm">
            <Text fz="md">{props.Tracklog.description}</Text>
            <Group gap={0} mt="md">
              {data}
            </Group>
        ...
        <Card.Section className={classes.end_publish} m={0} p={0}>
          <Center>
            <Button size="md" radius="xl" m="sm" onClick={props.close} variant="default">
              Voltar
            </Button>
            <Button size="md" radius="xl" m="sm" onClick={confirm}>
              Publicar
            </Button>
          </Center>
        </Card.Section>
